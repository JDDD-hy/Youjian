insert into private.achievement_strategy_catalog(
  ...
  'exercise_vitality','personal','once','session','count','ignore_after_unlock',
  'first_unlock','owner','none','focus.category_session','user_lifetime',
  'focus_session_id','catalog_v1','attained_stage_only','personal_tab','',
  'dumbbell','完成 10 次最终类型为“运动”的有效专注 session。','{}',
  '[{"stage":1,"threshold":10,"stage_key":"exercise_vitality","title":"生龙活虎"}]',
...
begin
  ...
  category_type:=case new.category::text
    ...
    when 'exercise' then 'exercise_vitality'
...
revoke all on function private.evaluate_catalog_personal_focus_achievements() from public,anon,authenticated;
