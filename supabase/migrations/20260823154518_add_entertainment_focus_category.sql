alter type public.focus_category add value if not exists 'entertainment';
...
insert into private.achievement_strategy_catalog(
  ...
  'joyful_pursuit','personal','once','session','count','ignore_after_unlock',
  'first_unlock','owner','none','focus.category_session','user_lifetime',
  'focus_session_id','catalog_v1','attained_stage_only','personal_tab','',
  'gamepad_2','完成 10 次最终类型为“娱乐”的有效专注 session。','{}',
  '[{"stage":1,"threshold":10,"stage_key":"joyful_pursuit","title":"乐在其中"}]',
