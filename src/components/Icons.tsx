...
const paths: Record<IconName, React.ReactNode> = {
  ...
  stats: (
    <>
      <path d="M5 20v-7M12 20V4M19 20V9" />
    </>
  ),
  target: (
    <>
  ...
  sparkle: (
    <>
      <path d="m12 3 1.3 4.3L18 9l-4.7 1.7L12 15l-1.3-4.3L6 9l4.7-1.7L12 3Z" />
      <path d="m19 15 .6 2 2.1.7-2.1.8-.6 2-.6-2-2.1-.8 2.1-.7.6-2Z" />
    </>
  ),
};
